...
export default function ServiceCard({ service, handleServiceClick, specialists, handleToggleStatus }) {
  return (
    <div
      key={service.id}
      className={`bg-white rounded-lg shadow overflow-hidden hover:shadow-lg transition-shadow ${!service.isActive ? "opacity-60" : ""
        }`}
    >
      <div className="p-6">
          ...
          <div className="relative">
            <Menu>
              ...
              >
                ...
                <MenuItem className="w-[180px] px-4 py-2 cursor-pointer data-[focus]:bg-gray-100">
                  <button
                    className={`text-left font-medium ${service.isActive ? "text-red-500" : "text-green-500"} `}
